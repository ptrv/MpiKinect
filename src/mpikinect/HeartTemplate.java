...
public class HeartTemplate {
	...
	public HeartTemplate(PApplet pApplet) {
		...
		stageImages[0] = pApplet.loadImage("./res/templates/template_heart_1.png");
		stageImages[1] = pApplet.loadImage("./res/templates/template_heart_2.png");
		stageImages[2] = pApplet.loadImage("./res/templates/template_heart_3.png");
