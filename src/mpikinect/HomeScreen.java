...
public class HomeScreen extends Screen {
	...
	public HomeScreen(AppMain p) {
		super(p);
		this.background = pApplet.loadImage("./res/screen1_bg_640.png");
		
		PImage imgButton1e = pApplet.loadImage("./res/buttons/button_1_1_empty.png");
		PImage imgButton1f = pApplet.loadImage("./res/buttons/button_1_1_full.png");
		PImage imgButton2e = pApplet.loadImage("./res/buttons/button_1_2_empty.png");
		PImage imgButton2f = pApplet.loadImage("./res/buttons/button_1_2_full.png");
